 ...
 * Plugin URI: http://www.wpcj.com/plugins/wpcjchimp
...
$wpcjChimp_first_module 		= 'wpcjchimp/index.php';
...
function wpcjChimp_load_backend() {
	...
	if ( is_admin() ){
		...
		if (substr($_REQUEST['page'],0,9) == 'wpcjchimp') {
			// Ayuda contextual
			add_filter( 'contextual_help', 'wpcjChimp_load_contextual_help' ); 
		} else {
			/*
			switch ($_SERVER['SCRIPT_NAME']) {
			case '/wp-admin/index.php';			// dashboard
			case '/wp-admin/edit.php';			// listado de entradas
			case '/wp-admin/post-new.php';		// Nuevo Post
...
global $wpcjChimp_error;
	...
	echo '
		<div class="wrap">
		<h2>wpCJ Chimp v'.VERSION.'</h2><h3 style="display:inline;">Automagically add your new blog users to your <a href="http://eepurl.com/gfKx" title="MailChimp">MailChimp List</a></h3>
	...
	echo '
		<div id="dashboard-widgets" class="metabox-holder" style="float:left;">
			<div id="side-sortables" class="meta-box ui" style="position: relative;">
	...
	echo '
		<tr valign="top">
			...
			<td>
				...
				<a class="button-secondary" href="http://eepurl.com/iSda" target="_blank">Sign up for our free newsletter!</a>
				<!-- \\ MAILCHIMP SUBSCRIBE CODE // -->
			</td>
		</tr>
		</table>
	...
	if ( $wpcjchimp['show-news']!='NO' ) {
		echo '
			<div id="dashboard-widgets" class="metabox-holder" style="float:left;overflow:hidden;position: relative;margin-left:10px;">
				<div id="side-sortables" class="meta-box ui" style="position: relative;">
					<div class="metabox-holder">
						<div class="meta-box" style="position: relative;">
				...
				<a href="http://wordpress.org/extend/plugins/wpcj-testimonials/" title="wpCJ Testimonials on WordPress.org">Have you tried our free<br/>wpCJ Testimonials plugin?</a>
				</p>
			</div>
		';
	}
	...
	if ( $wpcjchimp['dbfields'] != '' ) {
		$wpcjChimp_html = wpcjChimp_generate_code();
		echo '
			<div id="dashboard-widgets" class="metabox-holder" style="float:left;overflow:hidden;position: relative;margin-left:10px;width:290px;">
				<div id="side-sortables" class="meta-box ui" style="position: relative;">
					<div class="metabox-holder">
						<div class="meta-box" style="position: relative;">
